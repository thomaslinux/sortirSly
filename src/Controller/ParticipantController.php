...
//        récuperation du participant par son id
    ...
    public function update(ParticipantRepository $participantRepository, Request $request, EntityManagerInterface $entityManager, UserPasswordHasherInterface $passwordHasher, FileUploader $fileUploader): Response
    {
        //        récuperation du participant par son id
