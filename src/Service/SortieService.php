...
class SortieService
{
    ...
    {    }
    // Mise à jour des états des sorties lors de la recherche des sorties. Remplace la tâche CRON.
    ...
    // Recherche de l'appareil utilisé et restrictions appliquées sur les fonctionnalités accessibles
